...
Event.create(id: 1,active: true,attendees: "x1x2x3",title: "ALEX JONES WORSHIP",descriptioon: "Our lord and savior, Alex Jones, we are about to worship.", date: Time.now)
Event.create(id: 2,active: true,attendees: "x2x4",title: "Thot patrollin",descriptioon: "We out here looking for thots.")
Event.create(id: 4,active: true,attendees: "x2x4",title: "Meme Exchange",descriptioon: "I have the hottest memes from 2016, come view them and trade")
Event.create(id: 4,active: false,attendees: "x2",title: "Grapefruit party ;)",descriptioon: "Grapefruit is a fat burner")
